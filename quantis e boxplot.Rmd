...
IQ=Q3-Q1
cat("Vemos assimetria negativa, com dispersão de",IQ,"e nenhum outlier.")
...
cat("Vemos assimetria positiva, com dispersão de",IQ,"e a presença de",length(OUT),"outliers, que são:",OUT)
...
cat("Vemos assimetria negativa, com dispersão de",IQ,"e a presença de",length(OUT),"outliers.")
...
cat("Vemos assimetria positiva, com dispersão de",IQ,"e a presença de",length(OUT),"outliers.")
...
LI=Q1-1.5*IQ
OUT = CRE2[CRE2 < LI]
cat("Vemos assimetria negativa, com dispersão de",IQ,"e a presença de",length(OUT),"outlier, que é:",OUT)
